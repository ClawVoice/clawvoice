...
class TwilioMediaSessionHandler {
    ...
    startSilenceTimer(socket, session, teardownFn, systemPrompt) {
        ...
        if (promptLower.includes("hold") || promptLower.includes("wait"))
            return;
    ...
    resetSilenceTimer(socket, session, teardownFn, systemPrompt) {
