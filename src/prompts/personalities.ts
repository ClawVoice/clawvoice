...
const executiveGatekeeper: Personality = {
...
const friendlyReceptionist: Personality = {
...
const salesQualifier: Personality = {
  id: "sales-qualifier",
...
const technicalSupport: Personality = {
 ...
 */
export function personalizePrompt(prompt: string, ownerName?: string): string {
