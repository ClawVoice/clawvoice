    ...
    parameters: {
      ...
      properties: {
        ...
        purpose: {
          type: "string",
          description:
            "Background context for the voice agent. Include: who you represent, what to accomplish, relevant details, callback number. The agent uses this to guide the conversation but does NOT read it aloud. Example: 'Calling Dr. Smith's office on behalf of Cody McLain to schedule a dental cleaning. Prefer mornings, any day next week. Insurance is Delta Dental. Callback: 512-423-2622.'",
        },
        greeting: {
          type: "string",
          description:
            "The exact first sentence the agent speaks. Keep it short — one sentence only. Do NOT repeat the call purpose here. If omitted, a default disclosure greeting is used.",
        },
      },
