...
export const VOICEMAIL_INSTRUCTIONS =
  "If you reach a voicemail, answering machine, or automated greeting that asks you to leave a message:\n" +
...
export const OUTBOUND_CALL_INSTRUCTIONS = `${VOICEMAIL_INSTRUCTIONS}\n\n${IVR_INSTRUCTIONS}`;
